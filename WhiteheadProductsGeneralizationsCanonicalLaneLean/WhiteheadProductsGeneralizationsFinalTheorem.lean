...
import HautevilleHouse.WhiteheadProductsGeneralizationsCanonicalLaneLean.WhiteheadProductGeneralizationsGate
...
theorem constrained_whitehead_endgame (A : AdmissibleClass) : ConstrainedWhiteheadClosure A := by
